                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                <a href="{{ route('albums.edit', $album->id) }}"
                                                                    class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">Edit</a>
                                                                <!-- Button trigger modal -->
                                                                @if ($album->images()->count() > 0)
                                                                    <button type="button" class="btn btn-outline-danger btn-min-width box-shadow-3 mr-1 mb-1"
                                                                        data-toggle="modal"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="submit" class="btn btn-success" name="submit" value="move">Move Images to Another Album</button>
                                                                    </div>
                                                                    </form>
                                                                </div>
                                                            </div>
